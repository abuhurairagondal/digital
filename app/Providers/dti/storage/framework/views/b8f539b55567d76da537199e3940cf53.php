        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 mb-2" style="background-color: #F2F4F4; border-radius: 5px;">
                    ...
                    <div class="full">
                        <form name="save_bookcourse" action="/save_bookcourse" method="POST" style="margin-top: 60px;"
...
unset($__errorArgs, $__bag); ?>
  ...
  <option value="<?php echo e($cd->title); ?>" data-liveprice="<?php echo e($cd->live_price); ?>"  data-recordedprice="<?php echo e($cd->recorded_price); ?>"
                                                <?php if($cd->courses_id == $selected_course[0]->courses_id): ?> selected <?php endif; ?>><?php echo e($cd->title); ?>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="number" name="amount" id="amount" class="form-control"
                                        placeholder="0" required value="<?php echo e($selected_course[0]->recorded_price); ?>"
                                        readonly>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-md-12">
                                    <label>Account Details <code>*</code></label>
                                    ...
                                    <div class="row mt-3">
                                        <div class="col-md-6 text-center">
                                            <h5>JazzCash <img width="250" src="/images/jazz-cash.png" style="height: 50px; width: 50px;" alt="JazzCash"></h5>
                                            <label>Account Number <code>*</code></label>
                                            <input type="text" name="jazzcash_account" id="jazzcash_account" class="form-control" value="0317000000000" readonly>
                                        </div>
                                        <div class="col-md-6 text-center">
                                            <h5>EasyPaisa <img width="150" src="/images/easypaisa.png" style="height: 50px; width: 50px;" alt="EasyPaisa"></h5>
                                            <label>Account Number <code>*</code></label>
                                            <input type="text" name="easypaisa_account" id="easypaisa_account" class="form-control" value="0317000000000" readonly>
                                        </div>
                                    </div>
                                </div>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-md-12 mx-2" style="text-align: center; margin-top: 20px;">
                                        <input type="submit" value="Book Course"
    ...
    <script>
        $(document).ready(function() {
            $('#course').change(function() {
                ...
                var price = courseMode === 'Live Lecture' ? selectedCourse.data('liveprice') :
                    courseMode === 'Recorded Lecture' ? selectedCourse.data('recordedprice') : "";
                $('#amount').val(price);
            });
            ...
            $('#course_mode').change(function() {
                ...
                var price = courseMode === 'Live Lecture' ? selectedCourse.data('liveprice') :
                    selectedCourse.data('recordedprice');
                $('#amount').val(price);
            });
        });
    </script>
...
<script>
    // Update the selected account number based on the dropdown selection
    $(document).ready(function () {
        $('#selected_account').change(function () {
            var selectedAccount = $(this).val();
            if (selectedAccount === 'jazzcash') {
                $('#selected_account_number').val($('#jazzcash_account').val());
            } else if (selectedAccount === 'easypaisa') {
                $('#selected_account_number').val($('#easypaisa_account').val());
            } else {
                $('#selected_account_number').val('');
            }
        });
    });
</script>
...
<?php /**PATH C:\xampp\htdocs\OneDrive\learning_web\resources\views//bookcourse_form.blade.php ENDPATH**/ ?>