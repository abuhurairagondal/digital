   ...
   <body class="sub_page">
      ...
      <section class="inner_page_head">
        ...
        <div class="container" style="padding: 15px;">
            <div class="row">
                <div class="col-md-9">
                     <img src="/uploads/blogs/<?php echo $course[0]['pic'] ?>" class="img-fluid" alt="Image" style="border-radius:5px;">
                     <p>
    ...
    <ul class="list-unstyled">
        <?php $__currentLoopData = $courses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $otherJobs): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
               <li style="display: flex; align-items: center; margin-bottom: 10px; background-color: #fff; border-radius: 5px;">
                <img src="/uploads/blogs/<?php echo e($otherJobs->pic); ?>" alt="Thumbnail" class="img-thumbnail" style="margin-right: 10px; width: 5px; height: 5px;">
                <a href="<?php echo e($otherJobs->slug); ?>"><?php echo e($otherJobs->title); ?></a>
            </li>
...
<?php /**PATH C:\xampp\htdocs\OneDrive\learning_web\resources\views//details_bolgs.blade.php ENDPATH**/ ?>