                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select name="gender" id="gender"
                                            ...
                                            <option value <?php echo e(old('gender') == ''
                                                ? 'selected' : ''); ?>>Select
                                                Gender</option>
                                            <option value="male" <?php echo e(old('gender') == 'male' ?
                                                'selected' : ''); ?>>Male
                                            </option>
                                            <option value="female" <?php echo e(old('gender') == 'female' ?
                                                'selected' : ''); ?>>
                                                Female</option>
                                            <option value="other" <?php echo e(old('gender') == 'other' ?
                                                'selected' : ''); ?>>Other
                                            </option>
                                        </select>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <textarea name="dec"
                                            ...
                                            class="form_field" required><?php echo e(old('dec')); ?></textarea>
...
<?php /**PATH C:\xampp\htdocs\OneDrive\learning_web\resources\views//auth/job_form.blade.php ENDPATH**/ ?>