                                                ...
                                                <form name="BlogsForm" action="/save_blogs" method="POST"
                                                    ...
                                                    <div class="container-fluid">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6">
                                                                <label>Live<code>*</code></label>
                                                                <input type="number" name="slug" id="slug"
                                                                    class="form-control" required=""
...
<?php /**PATH C:\xampp\htdocs\OneDrive\learning_web\resources\views/admin/add_blogs.blade.php ENDPATH**/ ?>