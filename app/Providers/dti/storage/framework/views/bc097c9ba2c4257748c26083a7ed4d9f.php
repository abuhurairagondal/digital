...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="col-md-12 col-sm-12 mb-3">
          <div class="form-group">
            <a href="/forgot_password"><span style="color: #5044f7;">Forgot password?</span></a>
        ...
        <div class="text-center col-md-12" style="padding:5px; margin-top: 40px;">
         <p>Not a member?&nbsp;<a href="/register" style="color:#5644f7;">Register Here</a></p>
       </div>
...
<?php /**PATH E:\xampp\htdocs\OneDrive\learning_web\resources\views/auth/login.blade.php ENDPATH**/ ?>