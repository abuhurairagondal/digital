   ...
   <body class="sub_page">
      ...
      <section class="inner_page_head">
        ...
        <div class="container" style="padding: 15px;">
            <div class="row">
                <div class="col-md-9">
                     <img src="/uploads/jobs/<?php echo $course[0]['pic'] ?>" class="img-fluid" alt="Image" style="border-radius:5px;">
                     <p>
    ...
    <ul class="list-unstyled">
        <?php $__currentLoopData = $courses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $otherJobs): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
               <li style="display: flex; align-items: center; margin-bottom: 10px; background-color: #fff; border-radius: 5px;">
                <img src="/uploads/jobs/<?php echo e($otherJobs->pic); ?>" alt="Thumbnail" class="img-thumbnail" style="margin-right: 10px; width: 40px; height: 40px;">
...
<?php /**PATH E:\xampp\htdocs\OneDrive\learning_web\resources\views//details_jobs.blade.php ENDPATH**/ ?>