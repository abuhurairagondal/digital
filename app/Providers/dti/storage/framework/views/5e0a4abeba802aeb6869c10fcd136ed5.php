                                    ...
                                    <div class="tab-content" id="custom-tabs-four-tabContent">
                                        <div class="tab-pane fade show active" id="custom-tabs-four-home"
                                            ...
                                            <div class="card card-primary">
                                                <table id="example1" class="table table-bordered table-striped">
                                                    ...
                                                    <tbody>
                                                        <?php $__currentLoopData = $news; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cd): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <tr>
                                                            <td><?php echo e($cd->news_id); ?></td>
                                                            <td><?php echo e(\Carbon\Carbon::parse($cd->date)->format('d M y')); ?></td>

                                                            <td><a href="/news/<?php echo e($cd->slug); ?>" target="_blank"><?php echo e($cd->title); ?></a></td>
                                                            <td>
                                                            ...
                                                            <td>
                                                                <img src="/uploads/news/<?php echo e($cd->pic); ?>"
                                                                    style="width: 120px; height: 100px; object-fit: contain;">
                                                            </td>
                                                            <td>
                                                                <a href="/edit_news/<?php echo e($cd->news_id); ?>"
                                                                    class="btn btn-info btn-xs" title="Edit"><i
                                                                        class="fa fa-edit"></i></a>
                                                                <a onclick="return confirm('Are you sure to Delete?');"
                                                                    href="/delete_news/<?php echo e($cd->news_id); ?>"
                                        ...
                                        <div class="tab-pane fade" id="custom-tabs-four-profile" role="tabpanel"
                                            ...
                                            <div class="card card-primary">
                                                ...
                                                <form name="NewsForm" action="/save_news" method="POST"
...
<?php /**PATH E:\xampp\htdocs\OneDrive\learning_web\resources\views/admin/add_news.blade.php ENDPATH**/ ?>