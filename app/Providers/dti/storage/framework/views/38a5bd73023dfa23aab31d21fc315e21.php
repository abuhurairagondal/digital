                ...
                <div class="col-md-6 mb-2" style="border:2px solid #000000; border-radius: 10px">
                    ...
                    <div class="full">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="name" placeholder="Name" class="form_field" required
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" name="phone" placeholder="Phone" class="form_field" required
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="email" placeholder="Email" name="email" class="form_field" required
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-12 text-center">
                        <label for="pic" class="d-block">Receipt<code>*</code></label>
                        <div class="d-flex justify-content-center align-items-center">
                            <input type="file" name="pic" id="pic" class="form_field">
                        </div>
                        <?php $__errorArgs = ['pic'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
...
<?php /**PATH C:\xampp\htdocs\OneDrive\learning_web\resources\views//auth/bookcourse_form.blade.php ENDPATH**/ ?>