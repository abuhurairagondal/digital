            ...
            <div class="row">
                <div class="col-md-6 mb-2" style="background-color: #F2F4F4; border-radius: 5px;">
                    <h2 style="height: 50px; color: #000000 ; margin-top: 40px;" align="center"><strong>Book
                            Course</strong></h2>
                    <h1 style="color:blue; font-size: 30px; text-align:center;">{{ $selected_course[0]->title }}</h1>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="course" id="course" class="form-control" required>
                                        ...
                                        @foreach ($data as $cd)
  <option value="{{ $cd->title }}" data-liveprice="{{ $cd->live_price }}"  data-recordedprice="{{ $cd->recorded_price }}"
                                                @if ($cd->courses_id == $selected_course[0]->courses_id) selected @endif>{{ $cd->title }}
                                            </option>
                                        @endforeach
                                    </select>
                                    @error('course')
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="number" name="amount" id="amount" class="form-control"
                                        placeholder="0" required value="{{ $selected_course[0]->recorded_price }}"
                                        readonly>
                                    @error('amount')
                                        <p style="color: red;">{{ $message }}</p>
                                    @enderror
