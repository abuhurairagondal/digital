                                                ...
                                                <table id="example1" class="table table-bordered table-striped">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><a href="/course/{{ $cd->slug }}" target="_blank">{{
                                                                    $cd->title }}</a></td>
                                                                    <td>
                                                                        <p>{!! strlen(strip_tags($cd->detail)) > 35 ? substr(strip_tags($cd->detail), 0, 35) . '...' : $cd->detail !!}</p>
