...
<!-- Mirrored from utouchdesign.com/themes/realfun/index-3.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 30 Nov 2022 10:33:53 GMT -->
<head>
...
<div id="wrapper">   
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-12 margin-top-55">	
  ...
  <section class="fullwidth margin-top-70 padding-top-75 padding-bottom-70">
    <div class="container">
      <div class="row">
        <div class="col-md-12">	
			<div class="utf-section-headline-item centered margin-bottom-30 margin-top-0">
			  <h3 class="headline"><span>Most Sale Properties</span> For Sale Properties</h3>
			  <div class="utf-headline-display-inner-item">Most Sale Properties</div>
			  <p class="utf-slogan-text">Lorem Ipsum is simply dummy text printing and type setting industry Lorem Ipsum been industry standard dummy text ever since when unknown printer took a galley.</p>
			</div>  
		</div>
  ...
  <!-- For Rent -->
  <section class="padding-top-75 padding-bottom-70">
    <div class="container">
      <div class="row">
        <div class="col-md-12">	
			<div class="utf-section-headline-item centered margin-bottom-30 margin-top-0">
			  <h3 class="headline"><span>Most Rent Properties</span> For Rent Properties</h3>
			  <div class="utf-headline-display-inner-item">Most Rent Properties</div>
			  <p class="utf-slogan-text">Lorem Ipsum is simply dummy text printing and type setting industry Lorem Ipsum been industry standard dummy text ever since when unknown printer took a galley.</p>
			</div>  
		</div>
  ...
  <!-- Fullwidth Section -->
  <section class="fullwidth margin-bottom-0 padding-bottom-70 padding-top-75"> 
    <!-- Container -->
    <div class="container">
      <div class="row">
        <div class="col-md-12">	
  ...
  <section class="fullwidth padding-bottom-80 padding-top-75">
	  <!-- Container -->
	  <div class="container">
		<div class="row">
		  <div class="col-md-12">	
			<div class="utf-section-headline-item centered margin-bottom-30 margin-top-0">
			  <h3 class="headline"><span>Pricing Plan</span> Pay For What You Use</h3>
		...
		<div class="row need-help-area justify-content-center">
		  <div class="col-md-4 col-sm-4 col-xs-12">
			<div class="info-box-1">
			  ...
			  <a href="javascript:void(0);" class="button margin-top-10">Online Chat</a> 
			</div>
		  </div>
		  <div class="col-md-4 col-sm-4 col-xs-12">
			<div class="info-box-1">
			  ...
			  <a href="contact.html" class="button margin-top-10">Contact Us</a> 
			</div>
		  </div>
		  <div class="col-md-4 col-sm-4 col-xs-12">
			<div class="info-box-1">
			  ...
			  <a href="blog_list_right_sidebar.html" class="button margin-top-10">Read Blog Post</a> 
			</div>
		  </div>
		</div>
	  </div>
  ...
  <section class="fullwidth">
	  <div class="container">
		<div class="row">
		  <div class="col-md-12">	
			<div class="utf-section-headline-item centered margin-bottom-30 margin-top-0">
			  <h3 class="headline"><span>Our Agents</span> Our Agents</h3>
			  <div class="utf-headline-display-inner-item">Our Agents</div>
			  <p class="utf-slogan-text">Lorem Ipsum is simply dummy text printing and type setting industry Lorem Ipsum been industry standard dummy text ever since when unknown printer took a galley.</p>
			</div>  
		  </div>
		</div>
		<div class="row"> 
		  ...
		  <div class="utf-centered-button margin-top-10">
			<a href="agents-list.html" class="button">View All Agent</a> 
		  </div>
  ...
  <!-- Counters Container -->
  <div class="parallax" data-background="images/listings-parallax.jpg" data-color="#252529" data-color-opacity="0.85" data-img-width="800" data-img-height="505"> 
    <div id="counters">
      <div class="container">
        <div class="row">
          <div class="counter-boxes-inside-parallax">
            <div class="col-md-3 col-sm-6 col-xs-6">
              <div class="counter-box">
                <div class="counter-box-icon"> <i class="icon-feather-home"></i> <span class="counter">2242</span>
            ...
            <div class="col-md-3 col-sm-6 col-xs-6">
              <div class="counter-box">
                <div class="counter-box-icon"> <i class="icon-material-outline-business"></i> <span class="counter">1876</span>
            ...
            <div class="col-md-3 col-sm-6 col-xs-6">
              <div class="counter-box">
                <div class="counter-box-icon"> <i class="icon-feather-users"></i> <span class="counter">1270</span>
                  <p>User Agents</p>
                </div>
              </div>
            </div>
            <div class="col-md-3 col-sm-6 col-xs-6">
              <div class="counter-box last">
                <div class="counter-box-icon"> <i class="sl sl-icon-briefcase"></i> <span class="counter">1120</span>
                  <p>Booking Properti</p>
                </div>
              </div>
            </div>
          </div>
  ...
  <section class="fullwidth margin-bottom-0 padding-top-60 padding-bottom-65" data-background-color="linear-gradient(to bottom,rgba(0,0,0,0.03) 0%,rgba(255,255,255,0))"> 
    <!-- Logo Carousel -->
    <div class="container">
      <div class="row">
        <div class="col-md-12">	
...
<!-- Mirrored from utouchdesign.com/themes/realfun/index-3.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 30 Nov 2022 10:34:25 GMT -->
</html>