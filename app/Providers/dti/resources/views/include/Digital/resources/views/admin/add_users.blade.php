                                                ...
                                                <table id="example1" class="table table-bordered table-striped">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>{{ $cd->email }}</td>
                                                            <td>
                                                                <img src="/uploads/profile/{{ $cd->profile_picture }}"
                                        ...
                                        <div class="tab-pane fade  " id="custom-tabs-four-homejobs" role="tabpanel"
                                            ...
                                            <div class="card card-primary">
                                                <table id="example1" class="table table-bordered table-striped">
                                                    ...
                                                    <tbody>
                                                        @foreach ($jobsfrom as $cd)
                                                        <tr>
                                                            <td>{{ $cd->id }}</td>
                                                            <td>{{ $cd->name }}</td>
                                                            <td>{{ $cd->email }}</td>
                                                            <td>
                                                                <img src="/uploads/profile/{{ $cd->cv }}"
                                                                    style="width: 120px; height: 100px; object-fit: contain;"
                                                                    alt="No Image">
                                                            </td>
                                                            <td>{{ $cd->gender }}</td>
                                        ...
                                        <div class="tab-pane fade " id="custom-tabs-four-homecourse" role="tabpanel"
                                            ...
                                            <div class="card card-primary">
                                                <table id="example1" class="table table-bordered table-striped">
                                                    ...
                                                    <tbody>
                                                        @foreach ($bookcourse as $cd)
                                                        <tr>
                                                            <td>{{ $cd->id }}</td>
                                                            <td>{{ $cd->name }}</td>
                                                            <td>{{ $cd->email }}</td>
                                                            <td>
                                                                <img src="/uploads/profile/{{ $cd->pic }}"
                                                                    style="width: 120px; height: 100px; object-fit: contain;"
                                                                    alt="No Image">
                                                            </td>
                                                            <td>{{ $cd->gender }}</td>
