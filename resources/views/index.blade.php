...
<!-- Mirrored from utouchdesign.com/themes/realfun/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 30 Nov 2022 10:32:10 GMT -->
<head>
  ...
  <div class="utf-compare-slidebar-area">
    ...
    <div class="utf-smt-content">
      ...
      <div class="utf-smt-property-item"> 
        <!-- Property -->
        <div class="utf-listing-item compact"> <a href="/single-property-page-2" class="utf-smt-listing-img-container">
        ...
        <!-- Property -->
        <div class="utf-listing-item compact"> <a href="/singleproperty2" class="utf-smt-listing-img-container">
          <div class="utf-remove-compare-item"><i class="icon-line-awesome-close"></i></div>
          <div class="utf-listing-badges-item"><span class="for-sale">For Sale</span></div>
          <div class="utf-listing-img-content-item"> <span class="utf-listing-compact-title-item">Renovated Luxury Apartment <i>$420,000</i></span> </div>
      ...
      <div class="utf-smt-buttons"><a href="/compare-properties" class="button">Compare Property</a></div>
    </div>
  </div>
			...
			<div class="carousel"> 
			  <div class="utf-carousel-item-area">
				<div class="utf-listing-item"> 
				  <a href="/singleproperty1" class="utf-smt-listing-img-container">
				  ...
				  <div class="utf-listing-content">				
					<div class="utf-listing-title">
					  ...
					  <h4><a href="/singleproperty1">Renovated Luxury Apartment</a></h4>
					...
					<div class="utf-listing-user-info"><a href="/agents_profile"><i class="icon-line-awesome-user"></i> John Williams</a> <span>1 Days Ago</span></div>	
				  </div>
				</div>
			  </div>
			  
			  <div class="utf-carousel-item-area">
				<div class="utf-listing-item"> <a href="/singleproperty2" class="utf-smt-listing-img-container">
				  <div class="utf-listing-badges-item"> 
				  ...
				  <div class="utf-listing-content">
					<div class="utf-listing-title">
					  ...
					  <h4><a href="/singleproperty2">Renovated Luxury Apartment</a></h4>
					  <span class="utf-listing-address"><i class="icon-material-outline-location-on"></i> 2021 San Pedro, Los Angeles 90015</span> 
					</div>				
					<ul class="utf-listing-features">
					  <li><i class="fa fa-bed"></i> Beds<span>3</span></li>
			  ...
			  <div class="utf-carousel-item-area">
				<div class="utf-listing-item"> <a href="/singleproperty1" class="utf-smt-listing-img-container">
				  <div class="utf-listing-badges-item"> 
					<span class="featured">Featured</span> 
					<span class="for-rent">For Rent</span> 
				  </div>
			...
			<div class="col-md-6 col-sm-6 col-xs-12 callout-bg-1 callout-section-left pos-relative">
				...
				<div class="jbm-callout-in jbm-callout-in-padding pull-right">
					<div class="jbm-section-title margin-top-80 margin-bottom-80">
						...
						<a href="/add_new_property" class="button margin-top-10">Add New Property</a>
					</div>
				</div>
			</div>
			<div class="col-md-6 col-sm-6 col-xs-12 callout-bg-2 callout-section-right pos-relative">
				...
				<div class="jbm-callout-in jbm-callout-in-padding pull-left">
					<div class="jbm-section-title margin-bottom-80 margin-top-80">
						...
						<span class="section-tit-line"></span>
						<p>Lorem Ipsum is simply dummy text of printing and type setting industry. Lorem Ipsum been industry standard dummy text ever since, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries.</p>
						<a href="/listings-list-with-sidebar" class="button margin-top-10">Browse Properti</a>
	...
	<div class="container">
		<div class="row">
		  ...
		  <div class="col-md-4 col-sm-6"> 
			<a href="/listings-list-with-sidebar" class="img-box"> 
		...
		<div class="utf-centered-button margin-top-10">
			<a href="/allcatgory" class="button"> All Categories</a> 
		</div>
	 </div>
  </section>
  ...
  <section class="fullwidth" data-background-color="linear-gradient(to bottom,rgba(0,0,0,0.03) 0%,rgba(255,255,255,0))">
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-4"> 
          <div class="blog-post"> 
            <a href="/blog_detail_right_sidebar" class="post-img"> <img src="images/blog-post-01.jpg" alt=""> </a> 
            <div class="utf-post-content-area">
			  <h3><a href="/blog_detail_right_sidebar">What It Really Takes to Make $100k Before You Turn 30</a></h3>
        ...
        <div class="col-md-4"> 
          <div class="blog-post"> 
            <a href="/blog_detail_right_sidebar" class="post-img"> <img src="images/blog-post-02.jpg" alt=""> </a> 
            <div class="utf-post-content-area">
			  <h3><a href="/blog_detail_right_sidebar">The Best Canadian Merchant Account Providers.</a></h3>
			  <ul class="utf-blog-item-post-list">
				<li>By, John Williams</li>	
				<li>20 Jan, 2021</li>
			  </ul>
        ...
        <div class="col-md-4"> 
          <div class="blog-post"> 
            <a href="/blog_detail_right_sidebar" class="post-img"> <img src="images/blog-post-03.jpg" alt=""> </a> 
            <div class="utf-post-content-area">
			  <h3><a href="/blog_detail_right_sidebar">Hey Job Seeker, It’s Time To Get Up And Get Hired.</a></h3>
			  <ul class="utf-blog-item-post-list">
				<li>By, John Williams</li>	
				<li>20 Jan, 2021</li>
			  </ul>
...
<!-- Mirrored from utouchdesign.com/themes/realfun/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 30 Nov 2022 10:33:19 GMT -->
</html>