...
<!-- Mirrored from utouchdesign.com/themes/realfun/my-properties.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 30 Nov 2022 10:34:26 GMT -->
<head>
...
<div id="wrapper">   
  ...
  @include('include.header_my-properties')
    ...
    <div class="row">       
        ...
        <div class="sidebar margin-top-20">
          <div class="user-smt-account-menu-container">
            <ul class="user-account-nav-menu">
			  ...
			  <li><a href="my-properties.html" class="current"><i class="sl sl-icon-docs"></i> My Property</a></li>
      ...
      <div class="col-md-9">
        <table class="manage-table responsive-table">
          ...
          <tr>
            <td class="utf-title-container"><img src="images/listing-02.jpg" alt="">
              <div class="title">
                ...
                <span>2021 San Pedro, Los Angeles</span> <span class="table-property-price">$20,000/mo</span> 
			  </div>
			</td>
            <td class="utf-expire-date">12 Jan, 2021</td>
            <td class="action">
			    <a href="#" class="view tooltip left" title="View"><i class="icon-feather-eye"></i></a>
				<a href="#" class="edit tooltip left" title="Edit"><i class="icon-feather-edit"></i></a> 
				<a href="#" class="delete tooltip left" title="Delete"><i class="icon-feather-trash-2"></i></a>
			</td>
          </tr>
          <!-- Item #2 -->
          <tr>
          ...
          <!-- Item #4 -->
          <tr>
            <td class="utf-title-container"><img src="images/listing-06.jpg" alt="">
              <div class="title">
                <h4><a href="#">Renovated Luxury Apartment</a></h4>
                <span>2021 San Pedro, Los Angeles</span> <span class="table-property-price">$20,000/mo</span> 
			  </div>
        ...
        <a href="add-new-property.html" class="utf-centered-button margin-top-30 button">Submit New Property</a> 
	  </div>
    </div>
  </div>
