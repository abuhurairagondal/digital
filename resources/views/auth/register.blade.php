   ...
   <div class="row">
       ...
       <form name="registerform" action="/save_users" method="POST" style="margin-top: 60px;">
        ...
        <div class="row">
         ...
         <div class="col-md-6">
          ...
          <input type="text" name="name" placeholder="Name" class="form_field" required value="{{ old('name') }}">
          @error('name')
    ...
    @enderror
         ...
         <div class="col-md-6">
          ...
          <select name="city" id="city" class="form_field" required value="{{ old('city') }}">
        ...
        <div class="col-md-6">
          ...
          <input type="number" name="phone" placeholder="Phone" class="form_field" required value="{{ old('phone') }}">
          @error('phone')
                <p style="color: red;">{{ $message }}</p>
            @enderror
        </div>
         ...
         <div class="col-md-6">
          ...
          <input type="email" placeholder="Email" name="email" class="form_field" required value="{{ old('email') }}">
          @error('email')
                <p style="color: red;">{{ $message }}</p>
            @enderror
        </div>
        ...
        <div class="col-md-6">
            ...
            <input type="password" name="password" id="passwordField" placeholder="Password" class="form_field" required value="{{ old('password') }}" min="8">
