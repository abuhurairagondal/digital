                        ...
                        <div class="col-md-12">
                            <div class="card card-secondary">
                                ...
                                <div class="card-body">
                                    ...
                                    <form name="JobsForm" action="/update_jobs" method="POST"
                                        enctype="multipart/form-data">
                                        @csrf
                                        <input type="hidden" name="jobs_id"
                                            value="@php echo $jobs[0]['jobs_id'] @endphp">
                                        <div class="container-fluid">
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="title" id="title" placeholder="Title"
                                                            ...
                                                            value="@php echo $jobs[0]['title'] @endphp">
                                                        @error('title')
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <input type="text" name="slug" id="slug" class="form-control"
                                                        ...
                                                        value="@php echo $jobs[0]['slug'] @endphp">
                                                </div>

                                                <div class="col-md-1">
                                                    <img src="/uploads/jobs/@php echo $jobs[0]['pic'] @endphp"
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group mb-3">
                                                            ...
                                                            <input type="hidden" name="hidden_pic"
                                                                value="@php echo $jobs[0]['pic'] @endphp">
                                                        </div>
                                                        @error('pic')
                                                        <p class="help-block text-danger">{{ $message }}</p>
                                                        @enderror
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea name="detail" class="form-control textarea"
                                                            placeholder="Detail"
                                                            required>@php echo $jobs[0]['detail'] @endphp</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
